...
const Feelings = lazy(() => {
	return import('./components/Feelings')
})
...
function Home() {
	...
	function notReviewed() {
		...
		return document!.reviews.every((review) => {
			return review.guestId !== app!.guestId
		})
	}

	function userNotGiveFeeling() {
		if (document && !app!.guestId) return false
		return document!.feelings.every((feeling) => {
			return feeling.guestId !== app!.guestId
		})
	}
