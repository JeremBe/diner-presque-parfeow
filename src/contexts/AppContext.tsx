import { createContext, useState, type PropsWithChildren, type Dispatch, type SetStateAction } from "react"
...
export function UserProvider({ children }: PropsWithChildren) {
    ...
    return (
        <AppContext.Provider value={{ guestId, setGuestId, hosts, setHots }}>
            {children}
        </AppContext.Provider>
    )
}
